...
This site is intended for busy working people who want to take some time for themselves for some self-care to improve their focus, reduce stress or anxiety, improve quality of sleep or general self-improvement. This site will be useful to the target audience (young working women) as it offers a range of classes and concepts they can get involved in to achieve their self-care goals. 
...
![This is an image](/assets/images/responsive.png)

# Features
## Navigation:

- Featured at the top of the page, I went for a simple one page navigation bar. I choose this style as my website has a minimalist quality and I wanted the least amount of noise as possible.
...
- The information side bar asks the user *'What can we help you with?'*
- It is visually pleasing with the use of icons and pink text boxes. 
- Another text box is placed under these asking the user key questions to entice them into joining *'Peace + Mind'*

![This is an image](/assets/images/info.png)

## Our Gurus Side Bar

- The Guru side bar lists the practitioners that work at *'Peace + Mind.'*
- It lists their names and qualifications each separated by a line.
- I used this design as it is minimalist and gets straight to the point. The user can read what practitioners work there and what they then might be interested in. 

![This is an image](/assets/images/gurus.png)

## Join Us Form

- The join us section contains a form to collect details from the user so they can sign up and claim their free session with an expert guru. 
- The form collects the user's first name, second name, and email address. 
- The join us form is valuable to the user as it gives them the ability to sign up to *Peace + Mind* and claim their free session. 
- The form is programmed to be valid so that a person has to enter a valid email in the email box, a name in each name box and nothing else will be accepted.  
- The submit buttom works and stores the data. 
...
- I created a contact section that contains an email address, phone number and location of the yoga studio. 
- I placed this in boxes under the information bar.
- I noticed there was an obvious space on this side of the page and decided to place the contact box there. 
- I felt it ran in function and style with the information box. 
- It encourages the user to get in contact and gives them the ability to find and contact Peace + Mind if they need to. 

![This is an image](/assets/images/contact.png)

## Photo Grid

- I implemented a photo grid to display to the user a gallery of calming images and people doing different yoga poses. 
- I felt this was visually pleasing and encouraged the user to get involved. 
- It provides the user with supporting images to see what yoga sessions look like. 

![This is an image](/assets/images/photo-grid.png)

## Footer

- Social media links are placed in the footer with a clickable link. 
- I spaced out each social media platform for a more visually pleasing site. 
...
- I would like to get rid of this navigation and implement a burger menu. I like the current navigation, but I think a burger menu would look more aesthetically pleasing and allow the site to be more fluid. 

## Information Side Bar

- I would like to make each list item clickable links to take the user to more information on each item explaining how important meditation and yoga is for sleep, stress, focus etc. 
- I would also like these boxes to hover when the mouse is placed over them. 

## Our Gurus Side Bar

- I would like each expert guru to have their own profile so when clicked it would take the user to their profile where they could learn more about each practitioner. 

## Color Pallet

- In hindsight the color pallet of my site is quite feminine. As this is my target audience, I did not think it would be an issue, but potentially if I were to redesign the website a more gender neutral color may be a better choice. 


# Testing

- I tested that this site works in different browsers: Chrome, Firefox, Safari.
- I confirmed that this project is responsive, looks good and functions on all standard screen sizes.
- I confirm my sections- navigation, header, about us, join us, contact text is all readable and easy to understand. 
- I confirmed that my join us form works: requires entries in every field, will only accept an email in the email field, and the submit button works. 
...
3. Once selected go to source and select the branch to main and folder to the root. 
...
Some content from  *'about us'* section was taken from https://www.the-elbowroom.com/ 
